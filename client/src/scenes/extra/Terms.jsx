      ...
      <Box mt={4} mb={4}>
        ...
        <Box mb={4}>
            ...
            <Typography variant="body1">
              <Typography variant="body2">We are __________ ("Company," "we," "us," "our").</Typography>
              <Typography variant="body2">We operate , as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").</Typography>
              <Typography variant="body2">You can contact us by email at __________ or by mail to __________, __________, __________.</Typography>
        ...
        <Box mb={4}>
          ...
          <ul>
              {[
                ...
                <li key={index}>
                  <Link href={`#section-id${index + 1}`} variant="body1">
                    {index + 1}. {item}
                  </Link>
                </li>
              ))}
