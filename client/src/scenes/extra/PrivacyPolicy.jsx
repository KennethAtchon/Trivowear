...
import { Container, Typography, Box, Card, Link } from '@mui/material';
  ...
  return (
    <Container maxWidth="md">
      <Box mt={4} mb={4}>
        ...
        <Typography variant="body1" paragraph>
          <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Broovie LLC, 1 Cupertino, CA 95014.
        </Typography>
        <Typography variant="body1" paragraph>
        ...
        <Typography variant="body1" paragraph>
          <strong>Website</strong> refers to Broovie, accessible from www.broovie.org
        </Typography>
        <Typography variant="body1" paragraph>
        ...
        <Box component={Card} sx={{ p: 2 }}>
          ...
          <Typography variant="body1" paragraph>
            By email:{" "}
            <Link href="mailto:support@broovie.com">
              support@broovie.com
            </Link>
          </Typography>
        </Box>
